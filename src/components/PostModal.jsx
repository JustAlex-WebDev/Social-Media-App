    ...
    >
      <div className="h-full w-full max-w-[1140px] m-auto px-8 flex justify-center items-center text-white font-semibold">
        <div
          ...
          } bg-black flex flex-col justify-center items-center gap-4 px-8 rounded-2xl border-white shadow-white shadow-md w-full max-w-[34rem] h-80 ease-in-out duration-300 delay-300`}
        >
          <div
            className={`${
          ...
          >
            ...
            <div className="uppercase bg-[#BF0000] px-4 py-2 rounded-2xl font-bold hover:opacity-80 cursor-pointer text-sm">
              post
            </div>
          </div>
          <input
